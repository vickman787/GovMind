...
export function Dashboard({ onNavigate }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <section className="rounded-2xl border border-cyan-300/20 bg-cyan-300/[0.06] p-7 backdrop-blur-xl">
        <p className="text-sm font-semibold uppercase text-cyan-300">DAO activity overview</p>
          ...
          {!isLoading &&
            proposals.map((proposal) => (
              <button
                ...
                className="grid gap-3 rounded-xl border border-white/10 bg-black/20 p-4 text-left transition hover:border-fuchsia-300/50 md:grid-cols-[1fr_auto]"
              >
                <div>
